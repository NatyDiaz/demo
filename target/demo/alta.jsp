				...
				<section>
					...
					<form method="post"
						...
						<div class="mb-3">
							...
							<input name="color"  type="text" class="form-control" id="exampleFormControlInput1" placeholder="" maxlength="50">
						  </div>
						  <div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Stock</label>
							<input name="stock"  type="text" class="form-control" id="exampleFormControlInput1" placeholder="" maxlength="50">
						  </div>
